...
reviewsRouter.post("/", authRequired, async (req: any, res: Response, next: NextFunction) => {
...
reviewsRouter.delete("/:reviewId", authRequired, async (req: any, res: Response, next: NextFunction) => {
