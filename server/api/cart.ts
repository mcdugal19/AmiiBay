...
cartRouter.post("/", authRequired, async (req: any, res: Response, next: NextFunction) => {
...
cartRouter.patch("/:productId", authRequired, async (req: any, res: Response, next: NextFunction) => {
...
cartRouter.delete("/:productId", authRequired, async (req: any, res: Response, next: NextFunction) => {
  const { productId } = req.params;
...
cartRouter.delete("/", authRequired, async (req: any, res: Response, next: NextFunction) => {
  try {
