...
function mapOverProducts(rows: any[]) {
...
async function updateProduct(fields: any = {}) {
  const { id } = fields;
  delete fields.id;
...
import { deleteReviewsByProductId } from "./reviews.js";
import { clearProductFromAllCarts } from "./cart.js";
